...
impl RotateY {
    pub fn new(ptr: Box<dyn Hittable>, angle: f32) -> Self {
        ...
        for i in 0..2 {
            for j in 0..2 {
                for k in 0..2 {
                    let x = i as f32 * bbmax.x + (1 - i) as f32 * bbmin.x;
                    let y = j as f32 * bbmax.y + (1 - j) as f32 * bbmin.y;
                    let z = k as f32 * bbmax.z + (1 - k) as f32 * bbmin.z;
